  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">loves building web application.</span> I
        enjoy creating <span className="italic">websites & servers</span>. My
        focus is{" "}
        <span className="underline">
          Backend development and React (Nextjs)
        </span>
        .
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/p-rathod/"
          target="_blank"
        >
          {" "}
          <BsLinkedin />{" "}
        ...
        <a
          ...
          href="https://github.com/Parth0921"
          target="_blank"
        >
          {" "}
          <FaGithubSquare />{" "}
